        ...
        <div>
           ...
           <div className=" grid grid-cols-2 gap-5 mt-5">
                <div className="grid grid-cols-12">
                    ...
                    <img src={product.image} className="w-full col-span-8" />
                </div>
                <div className=" flex flex-col gap-5">
                    ...
                    <div className=" flex gap-5">
                        <div className=" flex gap-2 justify-center items-center">
                            <button className=" bg-gray-100 h-full w-10 font-bold text-xl rounded-xl flex justify-center items-center" onClick={HandleMinusQty}>-</button>
                            <span className=" bg-gray-200 h-full w-10 font-bold text-xl rounded-xl flex justify-center items-center">{quantity}</span>
                            <button className=" bg-gray-100 h-full w-10 font-bold text-xl rounded-xl flex justify-center items-center" onClick={HandlePlusQty}>+</button>
                        </div>
